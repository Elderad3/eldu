    ...
    <>
      ...
      <div className="bg-gradient-to-br from-indigo-900 to-green-900 min-h-screen overflow-auto">
        <div className="container max-w-5xl mx-auto px-4">
          <div className="w-4/5">
            <h1 className="mt-32 text-white text-6xl font-bold">Dados históricos e atuais do Brasil
            <span className="text-blue-400"> de um jeito descomplicado</span></h1>
          </div>
          ...
          <div className="text-white relative">
            <h3 className="text-uppercase font-semibold">Alguns dados disponíveis</h3>
